...
void CommandHandling::help(){
    cout <<"HELP "<< std::endl;
    cout <<"=========================================================================================="<<std::endl;
    cout <<"The expression evaluator accepts numeric constants, parentheses, and the following operators"<<std::endl;
    ...
    cout <<"-Missing Parentheses"<< std::endl;
    ...
    cout <<"(3 - 2       < Missing Parentheses"<< std::endl;
    cout <<"13 & 2       < Invalid Symbol"<< std::endl;
    cout <<"4 x 2        < Invalid Symbol"<< std::endl;
